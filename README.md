# Spring Boot - CentOS Docker image


This repository contains the sources and [Dockerfile](https://github.com/japorras/s2i-springboot-centos/blob/master/Dockerfile) of the base image for deploying Spring Boot applications as reproducible Docker images. The resulting images can be run either by [Docker](http://docker.io) or using [S2I](https://github.com/openshift/source-to-image).
...
```
$ s2i build https://github.com/atSistemas/polaris atsistemas/springboot-polaris springboot-polaris-app
